...
def cam():
    global img2,t1
    faceCascade = cv2.CascadeClassifier('src/Extra/haar.xml')
...
def facialrecog():
    ...
    if val<threshold:
        ...
        img3 = Image.open("src/Extra/noimage.jpg")
        img3 = img3.resize((256,256), Image.ANTIALIAS)
        img3 = ImageTk.PhotoImage(img3)
        label = Label(image = img3)
        label.place(x=672, y=161)
...
bgimg= ImageTk.PhotoImage(file = "src/Extra/final.jpg")
limg= Label(root, i=bgimg)
limg.pack()

f1="src/Extra/noimage.jpg"
t1=""
...
img2 = Image.open("src/Extra/noimage.jpg")
img2 = img2.resize((256,256), Image.ANTIALIAS)
img2 = ImageTk.PhotoImage(img2)
label = Label( image = img2)
...
button4 = ttk.Button(text="cam", command=cam)
button4.pack()
button4.place(x=73, y=285)
